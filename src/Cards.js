const Cards = {
  Mozi: [
    ...
    "Think of a big decision that you made or are about to make. What are the costs and benefits? Were more people hurt or helped by your decision?",
    "Think of someone you love. How many innocent strangers would you kill to save your loved one from immediate death? (Chapter 16)",
  ...
  Zhuangzi: [
    ...
    "When mourning the death of his wife, Zhuangzi beat a tub and sang. If one of your loved ones passed away, would you do the same? (Chapter 18)",
  ...
  Dongzhongshu: [
    "Imagine you are riding a train whose brakes are not working. You are headed towards a switch in the train tracks. If you continue on the current track, five people will be killed. You can pull a lever that switches the trolley to another track, saving the five people but killing another person standing on the tracks. Would you pull the lever?",
    ...
    "You are the leader of a small village. You are given a magical coin and offered the opportunity to flip it. If the coin lands on heads with probability X, everyone in your village will flourish. If the coin lands on tails, you and your subjects will die painful deaths. What is the lowest value you are willing to assign to X to choose to flip the coin?",
